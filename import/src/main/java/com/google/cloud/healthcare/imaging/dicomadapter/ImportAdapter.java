    ...
    public static void main(String[] args) throws IOException, GeneralSecurityException
    {
        ...
        if (isDebug)
        {
            flags = new Flags(
                    ...
                    "https://healthcare.googleapis.com/v1beta1/projects/centennial-dev/locations/northamerica-northeast1/datasets/AxonDataset1/dicomStores/AxonDataStore1/dicomWeb",//dicomweb_address=https://healthcare.googleapis.com/v1beta1/projects/${PROJECT}/locations/${LOCATION}/datasets/${DATASET}/dicomStores/${DICOMSTORE}/dicomWeb, Desc: Address for DicomWeb service. Must be a full path up to /dicomWeb if the Cloud Healthcare API is used.
                    ...
                    "C:\\ExecuteCmd\\ENV_AETS_JSON.json",// Desc: Path to json containing aet definitions (array containing name/host/port per element)
                    ...
                    "centennial-dev");// monitoring_project_id=${PROJECT}, Desc: Stackdriver monitoring project id, must be the same as the project id in which the adapter is running  } else
            {
